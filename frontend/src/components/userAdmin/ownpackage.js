                                    ...
                                    <div className="p-5">
                                        ...
                                        {product.map((product, key) => (
                                            <div className="row mb-4 d-flex justify-content-between align-items-center">
                                                ...
                                                <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                                    <button size='lg' type="button" className="btn btn-dark" color="dark" style={{ fontWeight: "bold", fontSize: "12px" }} onClick={() => add(product.name, product.category, parseInt(product.price))} >ADD</button>
                                                </div>
                                        ...
                                        {haircare.map((haircare, key) => (
                                            <div className="row mb-4 d-flex justify-content-between align-items-center">
                                                ...
                                                <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                                    <button size='lg' type="button" className="btn btn-dark" color="dark" style={{ fontWeight: "bold", fontSize: "12px" }} onClick={() => add(haircare.name, haircare.category, parseInt(haircare.price))} >ADD</button>
                                                </div>
                                        ...
                                        {nailcare.map((nailcare, key) => (
                                            <div className="row mb-4 d-flex justify-content-between align-items-center">
                                                ...
                                                <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                                    <button size='lg' type="button" className="btn btn-dark" color="dark" style={{ fontWeight: "bold", fontSize: "12px" }} onClick={() => add(nailcare.name, nailcare.category, parseInt(nailcare.price))} >ADD</button>
                                                </div>
