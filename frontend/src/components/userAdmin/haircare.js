                                ...
                                <MDBTableBody>
                                    {haircare.map((haircare, key) => (
                                        <tr className="bg-light">
                                            ...
                                            <td>
                                                <button size='lg' type="button" className="btn btn-dark" color="dark" style={{ fontWeight: "bold", fontSize: "12px" }} onClick={() => add(haircare.name, haircare.type, haircare.date, haircare.price)}>ADD</button>
                                            </td>
                                        </tr>
                                    ))}
                                </MDBTableBody>
