                    ...
                    <MDBCard className="border-0 shadow-0 p-5">
                        <MDBCardBody className="pt-5 mt-3 text-left">
                            <div className="bg-light p-4">
                                ...
                                <div className="mb-3">
                                    <label for="exampleFormControlInput1" className="form-label" style={{ fontSize: "20px" }}><b>User Name</b></label>
                                ...
                                <div className="mb-3">
                                    <label for="exampleFormControlInput1" className="form-label" style={{ fontSize: "20px" }}><b>Email</b></label>
                                ...
                                <div className="mb-3">
                                    <label for="exampleFormControlInput1" className="form-label" style={{ fontSize: "20px" }}><b>Phone Number</b></label>
                                ...
                                <div className="mb-3">
                                    <label for="exampleFormControlInput1" className="form-label" style={{ fontSize: "20px" }}><b>Password</b></label>
                                    <input className="form-control" type={passwordShown ? "text" : "password"} id="pass" style={{ fontSize: "18px" }} onChange={(e) => {
                                ...
                                <div className="mb-3">
                                    <label for="exampleFormControlInput1" className="form-label" style={{ fontSize: "20px" }}><b>Retype Password</b></label>
                                    <input className="form-control" type={passwordShown ? "text" : "password"} id="pass" style={{ fontSize: "18px" }} onChange={(e) => {
                                ...
                                <div className="mt-3 mb-2">
                                    <div className="d-grid gap-2">
                                        <br />
                                        <MDBBtn className="btn text-white bg-dark d-letter-spacing fw-light" style={{ fontSize: "18px" }} disabled={Registrationbtn} onClick={Registration}>Register</MDBBtn>
                                    </div>
                                </div>
                                ...
                                <center>
                                    <MDBRow >
                                        ...
                                        <MDBCol size='5'></MDBCol>
                                        <MDBCol size='2'><a href="/AdminLogin" style={{ fontSize: "18px" }} className="text-muted">Sign In</a></MDBCol>
                                    </MDBRow>
                                </center>
