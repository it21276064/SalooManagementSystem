                    ...
                    <MDBCard className="border-0 shadow-0 p-5">
                        <MDBCardBody className="pt-5 mt-3 text-left">
                            <div className="bg-light p-4">
                                ...
                                <br />
                                <div className="mb-3">
                                    <label for="exampleFormControlInput1" className="form-label" style={{ fontSize: "18px" }}>Email </label>
                                    <input className="form-control" type='email' id="pass" style={{ fontSize: "18px" }} onChange={(e) => {
                                        setEmail(e.target.value);
                                    }} />
                                </div>
                                <div className="mb-3">
                                    <label for="exampleFormControlInput1" className="form-label" style={{ fontSize: "18px" }}>Password</label>
                                    <input className="form-control" type="password" id="pass" style={{ fontSize: "18px" }} onChange={(e) => {
